...
function searchPagination() {
            return {
                ...
                getFilteredResults() {
                    ...
                    const beritaResults = beritaData.filter(item => item.title.toLowerCase().includes(query.toLowerCase()));
                    const galleryResults = galleryData.filter(item => item.title.toLowerCase().includes(query.toLowerCase()));
                    const videoResults = galleryVideo.filter(item => item.title.toLowerCase().includes(query.toLowerCase()));
